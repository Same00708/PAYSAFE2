...
import { fedapayService } from "../services/fedapay.js";
import { env } from "../config/env.js";
import { computePlatformFee } from "../services/fees.js";
import { notifyTransactionParties, notifyUser } from "../services/notifications.js";
import { assertTransition } from "../services/transactionFlow.js";
import {
  notifyBuyerOrderCreated,
  notifyDisputeOpened,
  notifySellerNewOrder,
  notifySellerPaymentReceived,
} from "../services/transactionNotify.js";
import {
  refundBuyerFull,
  settleSuccessfulTransaction,
} from "../services/transactionSettlement.js";
...
transactionsRouter.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const [buyer, seller, unreadMessages] = await Promise.all([
      ...
      import("../repositories/messages.js").then((m) =>
